		...
		<footer class ="footer-area">
			<div class ="container">
					...
					<div class ="col-lg-3 col-sm-6 col-md-6">
						<div class ="single-footer-widget">
							...
							<ul class ="footer-contact-info">
								...
								<li><span><i class ="fas fa-envelope"></i> &nbsp; </span> <a href="mailto:support@BrainStew.co.in">support@BrainStew.co.in</a></li>
                ...
                <div class ="copyright-area">
                    <p>Copyright @2022. All rights reserved by <a href="#">BrainStew</a></p>
                </div>
            </div>
